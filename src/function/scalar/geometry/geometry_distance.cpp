...
void GeometryDistance::RegisterFunction(BuiltinFunctions &set) {
	...
	distance.AddFunction(
	    ScalarFunction({LogicalType::GEOMETRY, LogicalType::GEOMETRY}, LogicalType::DOUBLE, GeometryDistanceFunction));
	distance.AddFunction(ScalarFunction({LogicalType::GEOMETRY, LogicalType::GEOMETRY, LogicalType::BOOLEAN},
	                                    LogicalType::DOUBLE, GeometryDistanceFunction));
