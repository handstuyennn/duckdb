...
void GeometryFromText::RegisterFunction(BuiltinFunctions &set) {
	...
	from_text.AddFunction(ScalarFunction({LogicalType::VARCHAR}, LogicalType::GEOMETRY, GeometryFromTextFunction));
	from_text.AddFunction(
	    ScalarFunction({LogicalType::VARCHAR, LogicalType::INTEGER}, LogicalType::GEOMETRY, GeometryFromTextFunction));
