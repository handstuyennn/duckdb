...
void GeometryCentroid::RegisterFunction(BuiltinFunctions &set) {
	...
	centroid.AddFunction(ScalarFunction({LogicalType::GEOMETRY}, LogicalType::GEOMETRY, GeometryCentroidFunction));
	centroid.AddFunction(
	    ScalarFunction({LogicalType::GEOMETRY, LogicalType::BOOLEAN}, LogicalType::GEOMETRY, GeometryCentroidFunction));
